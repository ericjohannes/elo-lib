...
from elo_lib.utils import calculate_elo, clean_name, expected_result, time_stamp
...
def update_elo(input: str, output_dir: str):
    ...
    with open("./data/output/league_latest_elos.json", "r") as f:
    ...
    with open(os.path.join(output_dir, "league_latest_elos.json"), "w") as f:
